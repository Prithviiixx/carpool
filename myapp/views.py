...
def findcar(request):
    ...
    if request.method == 'POST':
        ...
        Car.objects.create(car_name = 'Volkswagon',car_type = 'SUV',source = source_r, dest = dest_r,
        nos = 4, price = 50.6, rem=10,date = date_r, time=time.strftime("%H:%M:%S.%f", time.localtime()))
